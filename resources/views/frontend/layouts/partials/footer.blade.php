...
<footer>
                ...
                <div class="row">
                        ...
                        <div class="widget-column">
                            ...
                            <ul class="list-unstyled products-group">
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img1.jpg') }}" alt="Image Description"></a>
                                    </div>
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img2.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                                ...
                                <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                    <div class="col-auto">
                                        <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img3.jpg') }}" alt="Image Description"></a>
                                    </div>
                                    <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img4.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img5.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img6.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 col-lg-4">
                        ...
                        <ul class="list-unstyled products-group">
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img7.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img8.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                            ...
                            <li class="product-item product-item__list row no-gutters mb-6 remove-divider">
                                <div class="col-auto">
                                    <a href="../shop/single-product-fullwidth.html" class="d-block width-75 text-center"><img class="img-fluid" src="{{ asset('/backend/img/75X75/img9.jpg') }}" alt="Image Description"></a>
                                </div>
                                <div class="col pl-4 d-flex flex-column">
                    ...
                    <div class="col-wd-3 d-none d-wd-block">
                        <a href="../shop/shop.html" class="d-block"><img class="img-fluid" src="{{ asset('/backend/img/330X360/img1.jpg') }}" alt="Image Description"></a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="flex-center-between d-block d-md-flex">
                        ...
                        <div class="text-md-right">
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{ asset('/backend/img/100X60/img1.jpg') }}" alt="Image Description">
                            </span>
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{ asset('/backend/img/100X60/img2.jpg') }}" alt="Image Description">
                            </span>
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{ asset('/backend/img/100X60/img3.jpg') }}" alt="Image Description">
                            </span>
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{ asset('/backend/img/100X60/img4.jpg') }}" alt="Image Description">
                            </span>
                            <span class="d-inline-block bg-white border rounded p-1">
                                <img class="max-width-5" src="{{ asset('/backend/img/100X60/img5.jpg') }}" alt="Image Description">
                            </span>
                        </div>
                    </div>
                </div>
        ...
        <script src="{{ asset('/backend/vendor/appear.js') }}"></script>
        <script src="{{ asset('/backend/vendor/jquery.countdown.min.js') }}"></script>
        <script src="{{ asset('/backend/vendor/hs-megamenu/src/hs.megamenu.js') }}"></script>
        <script src="{{ asset('/backend/vendor/svg-injector/dist/svg-injector.min.js') }}"></script>
        ...
        <script src="{{ asset('/backend/vendor/fancybox/jquery.fancybox.min.js') }}"></script>
        <script src="{{ asset('/backend/vendor/typed.js/lib/typed.min.js') }}"></script>
        <script src="{{ asset('/backend/vendor/slick-carousel/slick/slick.js') }}"></script>
        <script src="{{ asset('/backend/vendor/bootstrap-select/dist/js/bootstrap-select.min.js') }}"></script>

        <!-- JS Electro -->
        <script src="{{ asset('/backend/js/hs.core.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.countdown.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.header.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.hamburgers.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.unfold.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.focus-state.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.malihu-scrollbar.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.validation.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.fancybox.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.onscroll-animation.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.slick-carousel.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.show-animation.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.svg-injector.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.go-to.js') }}"></script>
        <script src="{{ asset('/backend/js/components/hs.selectpicker.js') }}"></script>
